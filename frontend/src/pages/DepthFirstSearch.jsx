  ...
  return (
    <div>
      ...
      <div className="flex flex-col">
        <div className="flex flex-row gap-2 justify-center mt-4 text-white">
          <button
          ...
          <select
            className="px-3 py-2 rounded-md border border-gray-300 text-black focus:outline-none focus:ring-2 focus:ring-indigo-400"
